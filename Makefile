...
ECR_URI=620055013658.dkr.ecr.us-west-2.amazonaws.com/archeavy/static
...
kubelogs:
	kubectl logs `kubectl get pods | grep Running | grep static | cut -d ' ' -f 1`

bounce:
	kubectl rollout restart deployment archeavy-static-deployment
